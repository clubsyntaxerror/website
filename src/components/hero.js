                ...
                <>
                    <div className='bg-black bg-opacity-90 p-6 w-full flex flex-col justify-around items-center'>
                        <div className='md:w-2/3 flex flex-col justify-around items-center text-center'>
                            ...
                            <p className='text-sm md:text-3xl text-left text-gray-500'>{featuredEvent.eventDescription}</p>
                            <div className='text-left text-gray-500'>
                                <p className='mb-0 text-xs md:text-xl pb-1'><img src='/icons/date.png' className='inline align-text-middle md:align-text-top' width='18' height='18' /> {featuredEvent.longDate}</p>
                                <p className='mb-0 text-xs md:text-xl pb-1'><img src='/icons/time.png' className='inline align-text-middle md:align-text-top' width='18' height='18' /> {featuredEvent.openingHours}</p>
                                <address className='mb-0 text-xs md:text-xl not-italic'><img src='/icons/location.png' className='inline align-text-middle md:align-text-top pb-1' width='18' height='18' /> {featuredEvent.venueName}{featuredEventAddress}
                                ...
                                <p className='mb-0 text-xs  md:text-xl'><img src='/icons/ticket.png' className='inline align-text-middle md:align-text-top pb-1' width='18' height='18' /> {featuredEvent.optionalCoverFee ? featuredEvent.optionalCoverFee + ' SEK' : 'free to attend'}</p>
                            </div>
                        </div>
                    </div>
